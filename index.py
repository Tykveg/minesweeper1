...
k_mines = c.k_mines #Количество мин/Amount of mines
map_size = c.map_size #Размер карты/Map size
sq_size = c.sq_size #Размер одного квадрата в пикселях/Square size in px.
